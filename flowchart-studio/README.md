...
**Flowchart Studio** is a SOP Mojo product: a low-friction AI flowchart tool in the Builder Pro theme (dark zinc + lime `#B0FF56`). Photograph a handwritten scribble, talk the process through, or paste text. Edit the graph on a live canvas. Chat applies modular edits to the same JSON. Print / export / Send to Builder Pro sit behind a $19 unlock stub (or Builder Pro $47).
...
| `NEXT_PUBLIC_FLOWCHART_CHECKOUT_URL` | No | Unlock $19 CTA. If empty, Unlock $19 enables this browser (MVP stub) |
| `NEXT_PUBLIC_BUILDER_CHECKOUT_URL` | No | Defaults to `https://rpease1.mysamcart.com/checkout/sop-builder-pro` |
...
Copy: **Unlock $19 · Builder Pro $47 includes flowchart + import**
